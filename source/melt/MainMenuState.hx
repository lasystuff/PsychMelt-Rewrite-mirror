...
{
	public static var meltVersion:String = '0.6.3'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, 'Psych Melt (Psych Engine v 0.6.3)', 12);
						...
						else
						{
							FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
							{
								...
								switch (daChoice)
								{
									...
									case 'options':
										LoadingState.loadAndSwitchState(new melt.options.OptionsState());
								}
							});
						}
					});
