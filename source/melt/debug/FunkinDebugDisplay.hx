...
class FunkinDebugDisplay extends Sprite
{
	...
	function createSimpleElements():Void
	{
		...
		infoDisplay.defaultTextFormat = new TextFormat(Paths.font("montserrat.otf"), 12, color, JUSTIFY);
	...
	public function updateByOption()
	{
		switch (ClientPrefs.debugType.toLowerCase())
		{
			case "simple":
				this.visible = true;
				this.isAdvanced = false;
